...
.setTitle(`Code World Ticket Bot Altyapısı`)
.setFooter(`Code World Ticket Bot Altyapısı - Ticketing without clutter.`, client.user.avatarURL)
.setColor('GREEN')
...
.setFooter(`Code World Ticket Bot Altyapısı - Ticketing without clutter`, client.user.avatarURL)).then(m => {
m.react(`🔒`)
